...
class VideoMediaInline(MediaInline):
    ...
    fields = ('file', 'title', 'description', 'language')
...
class TranslatedCastAdmin(CastAdmin, TranslationAdmin):
    def formfield_for_dbfield(self, db_field, **kwargs):
        field = super(TranslatedCastAdmin, self).formfield_for_dbfield(db_field, **kwargs)
...
class ItineraryAdmin(MapAdmin):
    ...
    def formfield_for_dbfield(self, db_field, **kwargs):
        ...
        return super(ItineraryAdmin,self).formfield_for_dbfield(db_field,**kwargs)
...
class TranslatedItineraryAdmin(ItineraryAdmin, TranslationAdmin):
    def formfield_for_dbfield(self, db_field, **kwargs):
        field = super(TranslatedItineraryAdmin, self).formfield_for_dbfield(db_field, **kwargs)
        self.patch_translation_field(db_field, field, **kwargs)
        return field


class EventAdmin(MapAdmin, TranslationAdmin):
...
admin.site.register(models.TravelsUser, TravelsUserAdmin)
admin.site.register(models.Cast, TranslatedCastAdmin)
admin.site.register(models.Itinerary, TranslatedItineraryAdmin)
